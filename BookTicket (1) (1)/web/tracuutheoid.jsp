    ...
    <body>
        <div id="wrapper">
            <div class="navbar-custom">
                ...
                <!-- Search Form -->
                <form class="form-inline search-bar" style="margin-top: 12px" method="get" action="tracuutheoma">
                    <input class="form-control mr-sm-2" type="search" name="id" placeholder="Tìm Kiếm Mã" aria-label="Search">
                ...
                <div class="slimscroll-menu">
                    ...
                    <div id="sidebar-menu">
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li><a href="tracuukhachhang"> <span class="badge badge-success float-right">01</span><i class="fe-airplay"></i> Tất Cả KH </a></li>
                            <li><a href="tracuuchuyenbay"> <span class="badge badge-success float-right">01</span><i class="fe-airplay"></i> Tất Cả CB </a></li>
                        </ul>
                    </div>
